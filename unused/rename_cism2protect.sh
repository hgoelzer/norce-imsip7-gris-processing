...
if [[ "$exp" == *"ctrl_proj"* ]]; then
    ...
    # Heikos runs v04
    GCMnames=( ["01"]="MIROC5" ["02"]="NorESM1" ["03"]="HadGEM2-ES" ["04"]="IPSL-CM5-MR" ["05"]="CSIRO-Mk3.6" ["06"]="ACCESS1.3" ["07"]="CNRM-CM6" ["08"]="UKESM1-0-LL-Robin" ["09"]="CESM2-Leo" ["10"]="CNRM-ESM2" ["11"]="MPI-ESM1-2-HR" ["12"]="CESM2-CMIP6" ["13"]="NorESM2" ["14"]="UKESM1-0-LL-CMIP6" ["15"]="IPSL-CM6A-LR")
    declare -A SCENnames
